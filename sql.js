...
var sqls = [
  ...
  "create table if not exists point_order(id varchar(40) primary key, user_id varchar(40) not null default '', order_time timestamp not null default '', timeint integer not null default 0, order_status smallint not null default 0, goods_id varchar(40) not null default '', points integer not null default 0, number integer not null default 1, year integer not null default 0)"
